...
const DropdownMenu = ({ items, menuItems, isOpen, onClose, navbarHeight = 80, contentType = 'grid', navItem }: DropdownMenuProps) => {
  ...
  const displayMenuItems: MenuGridItem[] = selectedItem?.menuItems || menuItems || [
    { 
  ...
  const renderIcon = (iconName?: string) => {
    ...
    switch (iconName) {
      case "platform":
        return <Circle className={iconClass} size={iconSize} style={{ color: iconColor }} />
      case "eye":
        return <Eye className={iconClass} size={iconSize} style={{ color: iconColor }} />
      case "dollar":
        return <DollarSign className={iconClass} size={iconSize} style={{ color: iconColor }} />
      case "shield":
        return <Shield className={iconClass} size={iconSize} style={{ color: iconColor }} />
      case "lightbulb":
        return <Lightbulb className={iconClass} size={iconSize} style={{ color: iconColor }} />
      case "box":
        return <Box className={iconClass} size={iconSize} style={{ color: iconColor }} />
      case "refresh":
        return <RefreshCw className={iconClass} size={iconSize} style={{ color: iconColor }} />
      case "network":
        return <Network className={iconClass} size={iconSize} style={{ color: iconColor }} />
      case "link":
        return <Link2 className={iconClass} size={iconSize} style={{ color: iconColor }} />
      case "code":
        return <Code className={iconClass} size={iconSize} style={{ color: iconColor }} />
      case "monitor":
        return <Monitor className={iconClass} size={iconSize} style={{ color: iconColor }} />
      case "sparkles":
        return <Sparkles className={iconClass} size={iconSize} style={{ color: iconColor }} />
      case "workflow":
        return <Workflow className={iconClass} size={iconSize} style={{ color: iconColor }} />
      case "layers":
      ...
      case "zap":
        return <Zap className={iconClass} size={iconSize} style={{ color: iconColor }} />
      case "bar-chart":
        return <BarChart className={iconClass} size={iconSize} style={{ color: iconColor }} />
      case "users":
        return <Users className={iconClass} size={iconSize} style={{ color: iconColor }} />
      case "gauge":
        return <Gauge className={iconClass} size={iconSize} style={{ color: iconColor }} />
      case "lock":
        return <Lock className={iconClass} size={iconSize} style={{ color: iconColor }} />
      case "book":
        return <Book className={iconClass} size={iconSize} style={{ color: iconColor }} />
      case "chart":
        return <ChartBar className={iconClass} size={iconSize} style={{ color: iconColor }} />
      case "book-open":
        return <BookOpen className={iconClass} size={iconSize} style={{ color: iconColor }} />
      case "message-circle":
        return <MessageCircle className={iconClass} size={iconSize} style={{ color: iconColor }} />
      case "refresh-cw":
        return <RefreshCcw className={iconClass} size={iconSize} style={{ color: iconColor }} />
      case "check-circle":
        return <CheckCircle className={iconClass} size={iconSize} style={{ color: iconColor }} />
      case "settings":
        return <Settings className={iconClass} size={iconSize} style={{ color: iconColor }} />
      case "git-branch":
        return <GitBranch className={iconClass} size={iconSize} style={{ color: iconColor }} />
      case "cloud":
        return <Cloud className={iconClass} size={iconSize} style={{ color: iconColor }} />
      case "headphones":
        return <Headphones className={iconClass} size={iconSize} style={{ color: iconColor }} />
      default:
        return <Circle className={iconClass} size={iconSize} style={{ color: iconColor }} />
    }
  }
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                {items.map((item, index) => (
                  ...
                  >
                    ...
                    {/* Right arrow icon */}
                    <ChevronRight className="w-4 h-4 flex-shrink-0 text-white" style={{ strokeWidth: 1.5 }} />
                  </li>
                ))}
              </ul>
            </div>
